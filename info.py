...
PICS = (environ.get('PICS', 'https://graph.org/file/7ace64aafa97efa3c9352.jpg')).split() #SAMPLE PIC
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '1258310642').split()]
